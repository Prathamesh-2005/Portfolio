...
export const DATA = {
  ...
  description:
    "Full-Stack Developer | Spring Boot • React • Microservices | 750+ DSA Problems & Strong CS Fundamentals.",
  ...
  contact: {
    ...
    social: {
      ...
      Resume: {
        name: "Resume",
        url: "https://drive.google.com/file/d/1xpG6Fs6YSBCuiHBV8kIhEkbTFzMBPBws/view?usp=sharing",
        icon: Icons.resume,
        navbar: true,
      },
      email: {
